...
Important: Return only the JSON object, no markdown markers or any other text.
`;
...
Please provide helpful advice, solutions, and create a daily routine for them.
