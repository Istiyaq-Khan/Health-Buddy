...
const About = () => {
  return (
    <div className="about-container">
      <h1 className="glow-title">স্বাস্থ্যসাথী</h1>
      <p className="tagline">তোমার নিজের হাতে ছোট্ট হেলথ অ্যাসিস্টেন্ট 🤖💊</p>

      <section className="section-box">
        <h2>🌟 আমাদের ফিচার লিস্ট:</h2>
        <ul>
      ...
      <section className="section-box green-shadow">
        <h2>🌱 এই অ্যাপ কীভাবে সাহায্য করবে?</h2>
        <p>
